...
const Banner = () => {
    return (
        <div className='text-center pt-20 space-y-5 bg-base-300 px-5'>
            <div>
                <h1 className='text-7xl font-extrabold'>We Build <br /><span className='bg-linear-to-r from-[#6b35e5] to-purple-500 bg-clip-text text-transparent'>Productive</span> Apps</h1>
